...
import Answerss from "./Aswersss";
import Questionss from "./Questions";
class Quizapp2 extends React.Component {
  state = {
    questions: {
      1: "What is Your Goal ?",
  ...
  checkAnswer = (answer) => {
    const { score, step, correctAnswers } = this.state;
    ...
    return (
      <div>
        {step <= Object.keys(questions).length ? (
          <div>
            <h1>Weilcome To Our Page</h1>
            <Questionss question={questions[step]} />
            <Answerss
              answer={answers[step]}
          ...
          <div>
            <h1>Thanks for Completed Your Task</h1>
            <p>
